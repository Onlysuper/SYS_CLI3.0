...
import {
  ...
  Breadcrumb as eleBreadcrumb,
  BreadcrumbItem as eleBreadcrumbItem,
  Card as eleCard,
  Main as eleMain,
  MessageBox,
  Message,
...
Vue.component(eleBreadcrumb.name, eleBreadcrumb)
Vue.component(eleBreadcrumbItem.name, eleBreadcrumbItem)
...
Vue.component(eleStep.name, eleStep)
...
new Vue({
  store,
  router: window.isMobile ? routerApp : router,
  render: h => h(App)
}).$mount('#app') 
