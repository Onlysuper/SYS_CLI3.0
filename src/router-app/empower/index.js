      ...
      children: [
        {
          ...
          component: r => {
            loading(true);
            return require.ensure([], () => { loading(false); return r(require("@src/views-app/empower/empowerManage")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理",
            keepAlive: true,
        ...
        },
        {
          ...
          path: 'search',
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/search")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
        ...
        // },
        {
          ...
          path: 'edit/:authCode',
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/edit")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
        },
        {
          ...
          path: 'bind/:authCode',
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/bind")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
        },
        {
          ...
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/bindchild")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
        },
        {
          ...
          path: 'build',
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/build")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
        },
        {
          ...
          path: 'addMateriel',
          component: r => {
            return require.ensure([], () => { return r(require("@src/views-app/empower/empowerManage/addMateriel")) }, "empower-manage-app")
          },
          meta: {
            pageTitle: "授权码管理"
          }
