...
const getCustomers = () => {
    return (params) => {
        return http.get(base.oaIp, "/customer/page", params)
    }
}
// 新增
...
//代付订单查询
const getMctPayforOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/proxyPay/page", params) } }
const getMctPayforOrdersSum = () => { return (params) => { return http.merpost(base.merIp, "/customer/proxyPay/total", params) } }
// 交易订单查询
const getMctTradingOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/page", params) } }
const getMctTradingOrdersSum = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/total", params) } }
const getMctTradingOrdersExport = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/excel", params) } }
// zf1500
const getMctTradingOrdersGw = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/gwPage", params) } }
const getMctTradingOrdersSumGw = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/gwTotal", params) } }
const getMctTradingOrdersExportGw = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/gwExcel", params) } }
// 线上商户查询
const getMctManageOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/boss/customer/page", params) } }
const getMctManageOrdersAdd = () => { return (params) => { return http.merpost(base.merIp, "/customer/service", params) } }
const getMctManageOrdersSum = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/page", params) } }
const getMctManageOrdersExport = () => { return (params) => { return http.merpost(base.merIp, "/customer/payOrder/page", params) } }
//线上服务商查询
const getOnlineFacilitatorOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/boss/agent/page", params) } }
const postUptateFacilitatorOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/boss/agent/saveorupdate", params) } }
// 线上限额管理
const getMctQuotaOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/amount/limit/page", params) } }
const postAddMctQuotaOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/amount/limit/saveorupdate", params) } }

// 商户扩展配置
const postMerExtendConfigs = () => { return (params) => { return http.merpost(base.merIp, "/customer/expand/page", params) } }
const postUpdateMerExtendConfigs = () => { return (params) => { return http.merpost(base.merIp, "/customer/expand/saveorupdate", params) } }

//代付账户余额
const getMctBalanceOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/proxyPayMapping/page", params) } }
const getMctBalanceOrdersOne = () => { return (params) => { return http.merpost(base.merIp, "/customer/proxyPay/proxyPayAccQuery", params) } }

//商户池
const getMctPoolOrders = () => { return (params) => { return http.merpost(base.merIp, "/customer/pool/page", params) } }
const postEditMctPoolOrder = () => { return (params) => { return http.merpost(base.merIp, "/customer/pool/saveorupdate", params) } }
const postBatchUpdateMctPoolOrder = () => { return (params) => { return http.merpost(base.merIp, "/customer/pool/updatebatchcustomer", params) } }
export {
    Login,
    Logout,
    MenuGet,
    ...
    getMctTradingOrdersExport,
    //zf15000
    getMctTradingOrdersGw,
    getMctTradingOrdersSumGw,
    getMctTradingOrdersExportGw,
    // 线上商户查询
    getMctManageOrders,
    getMctManageOrdersAdd,
    getMctManageOrdersSum,
    getMctManageOrdersExport,
    //线上服务商查询
