  ...
  <div class="search-page" @keyup.enter="searchStart">
    ...
    <el-form size="small" :class="[visibleinput?'showform-box':'visibleform-box','form-box']" ref="searchform" :label-width="searchOptions.lableWidth">
      ...
      <div class="time-check-box">
        <el-button-group>
          <el-button size="mini" type="primary" icon="el-icon-edit">昨天</el-button>
          <el-button size="mini" type="primary" icon="el-icon-share">前天</el-button>
          <el-button size="mini" type="primary" icon="el-icon-delete">上星期</el-button>
        </el-button-group>
      </div>
