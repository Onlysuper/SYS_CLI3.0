...
export default {
  ...
  methods: {
    ...
    // scrollItem(elem) {
    //   this.meunScroll.scrollToElement(elem.target, 1000, 0, 0)
    // },
    _initScroll() {
      ...
      this.meunScroll.scrollToElement(activeElement[0], 0, 0, 0);
    }
  },
  ...
  mounted() {
    ...
    // this.meunScroll.scrollTo(this.activeIndex * 100, 0, 100, easing);
