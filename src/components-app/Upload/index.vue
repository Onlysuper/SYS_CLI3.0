...
let demoImg = {
  ...
  //结算人身份证人面像
  CARDHOLDER_ID_POSITIVE: require("./img/identityFrontImg.png"),
  //结算人身份证国徽面
  CARDHOLDER_ID_BACK: require("./img/identityFrontImg.png"),
  //结算人手持身份证
  CARDHOLDER_WITH_ID: require("./img/identityFrontImg.png"),
  //一下为美食行业
  //微信标示前台照
  WECHATLOGO_CASHSPACE: require("./img/identityFrontImg.png"),
  //支付宝标示前台照
  ALIPAYLOGO_CASHSPACE: require("./img/identityFrontImg.png"),
  //三方平台凭证
  CATERIMG_PLATFORM_CERTIFICATE: require("./img/identityFrontImg.png"),
  //BD与门头合影
  PROVIDER_STOREDOOR: require("./img/identityFrontImg.png"),
  //BD与微信所有物料
  PROVIDER_WECHAT_SCAN: require("./img/identityFrontImg.png"),
  //BD与支付宝所有物料
  PROVIDER_ALIPAY_SCAN: require("./img/identityFrontImg.png"),
  //餐饮许可证
  CATERIMG_PERMIT: require("./img/identityFrontImg.png")
};
export default {
  props: {
    value: {
