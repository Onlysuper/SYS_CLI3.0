<template>
  ...
  <div class="changebill-detail-box">
    <el-tabs :tab-position="'right'" style="height: 100%;">
      ...
      <el-tab-pane label="变更后" style="height: 100%;overflow:hidden">
        <div v-if="true" class="product-detail-body change-before">
          <div class="detaile-left">
            ...
            <div :class="'scroll-view-cus detail-box-pro rightVsible' + detailRightVisible">
              ...
              <div class="line-label-box">
                <span class="lable-title gray-back">邮箱:</span>
                <span class="line-label-last">{{newData.contactEmail}}</span>
              </div>
              <div class="line-label-box">
                <span class="lable-title gray-back">身份证有效期:</span>
...
export default {
  ...
  methods: {
    ...
    getCustomerEcho(imgsArr, initName) {
      ...
      if (imgsArr.category == '2015050700000000') {
        // 美食
        oldImgsRow.wechatLogoCashSpaceImg = {
          id: imgsArr.wechatLogoCashSpaceImgId,
          imgname: "微信标示前台照",
          url: this.changeUrl(imgsArr.wechatLogoCashSpaceImg)
        }
        oldImgsRow.alipayLogoCashSpaceImg = {
          id: imgsArr.alipayLogoCashSpaceImgId,
          imgname: "支付宝标示前台照",
          url: this.changeUrl(imgsArr.alipayLogoCashSpaceImg)
        }
        oldImgsRow.caterimgPlatformCertificateImg = {
          id: imgsArr.caterimgPlatformCertificateImgId,
          imgname: "三方平台凭证",
          url: this.changeUrl(imgsArr.caterimgPlatformCertificateImg)
        }
        oldImgsRow.providerStoredoorImg = {
          id: imgsArr.providerStoredoorImgId,
          imgname: "BD与门头合影",
          url: this.changeUrl(imgsArr.providerStoredoorImg)
        }
        oldImgsRow.providerWechatScanImg = {
          id: imgsArr.providerWechatScanImgId,
          imgname: "BD与微信所有物料",
          url: this.changeUrl(imgsArr.providerWechatScanImg)
        }
        oldImgsRow.providerAlipayScanImg = {
          id: imgsArr.providerAlipayScanImgId,
          imgname: "BD与支付宝所有物料",
          url: this.changeUrl(imgsArr.providerAlipayScanImg)
        }
        oldImgsRow.caterimgPermitImg = {
          id: imgsArr.caterimgPermitImgId,
          imgname: "餐饮许可证",
  ...
  computed: {
    imgIP() {
      // nginx配置的路由
      return this.$store.state.Base.imgIP;
    }
  }
};
</script>
