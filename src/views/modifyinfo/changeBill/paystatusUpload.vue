    ...
    <div v-if="formVisible" class="paystatusUpload-box">
      <el-form class="paystatusform" size="small" label-position="right" :model="payStatusForm" ref="payStatusForm" :rules="payStatusFormRules" label-width="80px">
        <div class="upload-group">
          ...
          <!-- 美食行业 -->
          <upload-img v-if="category=='food'" :label="'微信标示前台照'" :upType="'WECHATLOGO_CASHSPACE'" :imgKey="'wechatLogoCashSpaceImg'" :defaultImg='wechatLogoCashSpaceImg' ref="cardHolderIdImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'支付宝标示前台照'" :upType="'ALIPAYLOGO_CASHSPACE'" :imgKey="'alipayLogoCashSpaceImg'" :defaultImg='alipayLogoCashSpaceImg' ref="alipayLogoCashSpaceImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'三方平台凭证'" :upType="'CATERIMG_PLATFORM_CERTIFICATE'" :imgKey="'caterimgPlatformCertificateImg'" :defaultImg='caterimgPlatformCertificateImg' ref="caterimgPlatformCertificateImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'BD与门头合影'" :upType="'PROVIDER_STOREDOOR'" :imgKey="'providerStoredoorImg'" :defaultImg='providerStoredoorImg' ref="providerStoredoorImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'BD与微信所有物料'" :upType="'PROVIDER_WECHAT_SCAN'" :imgKey="'providerWechatScanImg'" :defaultImg='providerWechatScanImg' ref="providerWechatScanImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'BD与支付宝所有物料'" :upType="'PROVIDER_ALIPAY_SCAN'" :imgKey="'providerAlipayScanImg'" :defaultImg='providerAlipayScanImg' ref="providerAlipayScanImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
          <upload-img v-if="category=='food'" :label="'餐饮许可证'" :upType="'CATERIMG_PERMIT'" :imgKey="'caterimgPermitImg'" :defaultImg='caterimgPermitImg' ref="caterimgPermitImg" :sendData="allImgData" :action="oaIp+'/bussinessImg/upload'" :uploadApi="uploadApi" @result="saveOneImg"></upload-img>
        </div>
        <div class="agree-box">
