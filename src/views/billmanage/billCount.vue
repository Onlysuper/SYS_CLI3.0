    ...
    <div class="admin-main-box">
      ...
      <div class="operation-box">
        <el-button-group class="button-group">
          ...
          <el-button v-if="adminFilter('billcountagent_sum')" class="mybutton" @click="SumHandle" :loading="sumLoading" size="small"
            type="primary" icon="el-icon-plus">合计</el-button>
...
<script>
  ...
  export default {
    ...
    activated() {
      if (this.adminFilter('billcountagent_sum')) {
        this.SumHandle();
      }
    }
  };
