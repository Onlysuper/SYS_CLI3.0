  ...
  <div class="admin-page">
    ...
    <el-dialog title="新增邮箱配置" center :visible.sync="addFormVisible">
      <el-form size="small" ref="editForm" :model="editForm" label-width="110px" :rules="editFormRules">
        ...
        <el-form-item :label="editForm.bussinessType=='customer'?'商户编号':'合伙人编号'" prop="bussinessNo">
          <el-input :disabled="isEdit" v-model="editForm.bussinessNo" :placeholder="editForm.bussinessType=='customer'?'商户编号':'合伙人编号'"></el-input>
        </el-form-item>
