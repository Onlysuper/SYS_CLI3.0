<template>
  <div class="paystatusInfo-box">
    <el-form size="small" :model="payStatusForm" ref="payStatusForm" :rules="payStatusFormRules" :label-width="formLabelWidth">
      ...
      <el-form-item class="full-width" label="银行卡预留手机号" prop="reservedPhoneNo" :label-width="formLabelWidth">
      ...
      <!-- <el-form-item v-if="bankAreaVisible" class="full-width" prop="bankArea" label="开户行地区"> -->
      <el-form-item class="full-width" :prop="isBankAreaRule" label="开户行地区">
...
export default {
  ...
  data() {
    return {
      ...
      payStatusFormRules: {
        ...
        bankArea: [
          { required: true, message: "请选择开户行地区", trigger: "blur,change" }
        ],
    ...
    getCustomerEcho() {
      getCustomerEchoProduct()({
        ...
        if (res.code == "00") {
          ...
          console.log("unionCodeunionCodeunionCodeunionCode");
          console.log(newSettleCard);

          this.getaccountName = newSettleCard.accountName;// 带入的账户名称
          ...
          // Object.assign(this.payStatusForm, this.cacheForm);
          this.payStatusForm = Object.assign({}, this.payStatusForm, { accountName: accountName }, { ...this.payStatusForm }, { ...newCustomer }, { ...this.cacheForm }, { ...newSettleCard });
  ...
  computed: {
    ...
    isBankAreaRule() {
      if (this.payStatusForm.branchName == "") {
        return "bankArea"
      } else {
        return ""
      }
