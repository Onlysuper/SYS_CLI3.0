    ...
    <el-dialog center title="导入商户信息" :visible.sync="importVisible">
      <el-form size="small" :model="importForm" ref="importForm" :rules="importFormRules">
        ...
        <el-form-item label="商品文件" :label-width="formLabelWidth">
          <el-upload :with-credentials="true" :headers='{"X-requested-With": "XMLHttpRequest"}' :limit="1" :on-exceed="handleExceed"
            :data="importForm" :before-upload="beforeUpload" :on-success="uploadSuccess" :on-error="uploadError" :auto-upload="false"
            ref="upload" class="upload-demo" drag :action="oaIp+'/customerGoods/importGoods'">
