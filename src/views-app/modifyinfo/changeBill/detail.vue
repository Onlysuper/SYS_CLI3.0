        ...
        <div class="container-box">
          <mt-tab-container-item id="oldData">
            ...
            <view-radius class="uploads imagesParent" id="WeixinJSBridge">
              ...
              <!-- 美食 -->
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="wechatLogoCashSpaceImg" :label="'微信标示前台照'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="alipayLogoCashSpaceImg" :label="'支付宝标示前台照'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="caterimgPlatformCertificateImg" :label="'三方平台凭证'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="providerStoredoorImg" :label="'BD与门头合影'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="providerWechatScanImg" :label="'BD与微信所有物料'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="providerAlipayScanImg" :label="'BD与支付宝所有物料'"></show-img-view>
              <show-img-view v-show="categoryOld=='food'" class="item" :disabled="true" ref="caterimgPermitImg" :label="'餐饮许可证'"></show-img-view>
            </view-radius>
            <!-- 更新前end -->
        ...
        <mt-tab-container-item id="newData">
          ...
          <div class="container-box">
            ...
            <view-radius class="uploads imagesParent" id="WeixinJSBridgeAfter">
              ...
              <!-- 美食 -->
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="wechatLogoCashSpaceImgNow" :label="'微信标示前台照'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="alipayLogoCashSpaceImgNow" :label="'支付宝标示前台照'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="caterimgPlatformCertificateImgNow" :label="'三方平台凭证'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="providerStoredoorImgNow" :label="'BD与门头合影'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="providerWechatScanImgNow" :label="'BD与微信所有物料'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="providerAlipayScanImgNow" :label="'BD与支付宝所有物料'"></show-img-view>
              <show-img-view v-show="categoryNew=='food'" class="item" :disabled="true" ref="caterimgPermitImgNow" :label="'餐饮许可证'"></show-img-view>
            </view-radius>
          </div>
          <!-- 更新后end -->
        </mt-tab-container-item>
...
export default {
  ...
  methods: {
    ...
    changeUrl(url) {
      let before = this.imgIP;
      if (url && utils.isString(url)) {
        if (url.indexOf("/nfs/test") != -1) {
          return url.replace("/nfs/test", before)
        }
        if (url.indexOf("/nfs") != -1) {
          return url.replace("/nfs", before)
        }
      } else {
        return url
      }
    ...
    echoForm(imgsArr, type) {
      let imgsAll = {
        ...
        //美食
        cardHolderIdImg: {
          id: imgsArr.cardHolderIdImg,
          imgname: "微信标示前台照",
          url: this.changeUrl(imgsArr.cardHolderIdImg)
        },
        alipayLogoCashSpaceImg: {
          id: imgsArr.alipayLogoCashSpaceImg,
          imgname: "支付宝标示前台照",
          url: this.changeUrl(imgsArr.alipayLogoCashSpaceImg)
        },
        caterimgPlatformCertificateImg: {
          id: imgsArr.caterimgPlatformCertificateImg,
          imgname: "三方平台凭证",
          url: this.changeUrl(imgsArr.caterimgPlatformCertificateImg)
        },
        providerStoredoorImg: {
          id: imgsArr.providerStoredoorImg,
          imgname: "BD与门头合影",
          url: this.changeUrl(imgsArr.providerStoredoorImg)
        },
        providerWechatScanImg: {
          id: imgsArr.providerWechatScanImg,
          imgname: "BD与微信所有物料",
          url: this.changeUrl(imgsArr.providerWechatScanImg)
        },
        providerAlipayScanImg: {
          id: imgsArr.providerAlipayScanImg,
          imgname: "BD与支付宝所有物料",
          url: this.changeUrl(imgsArr.providerAlipayScanImg)
        },
        caterimgPermitImg: {
          id: imgsArr.caterimgPermitImg,
          imgname: "餐饮许可证",
          url: this.changeUrl(imgsArr.caterimgPermitImg)
        }
      };
      ...
      if (imgsArr.category == '2015050700000000') {
        this.categoryOld = "";
        this.categoryNew = "";
        if (type == 'oldData') {
          this.categoryOld = "food"
        } else {
          this.categoryNew = "food"
        }
      }
      // 图片预览
      this.$nextTick(() => {
