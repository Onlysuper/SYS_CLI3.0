  ...
  <full-page>
    ...
    <view-radius>
      <input-wrapper>
        ...
        <div v-if="$store.state.userInfoAndMenu.isAdmin||$store.state.userInfoAndMenu.isOnlyAgent">
  ...
  methods: {
    ...
    init() {
      this.getCustomerProductOne(this.queryNo).then(resdata => {
        ...
        this.dataList.createTime = rowdata.createTime;
    ...
    save() {
      ...
      let createTime = this.dataList.createTime;
